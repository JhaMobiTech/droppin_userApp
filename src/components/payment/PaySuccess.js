...
import { styles } from '../../styles/paySuccessStyle';
        ...
        <Content style={{ flex: 1, backgroundColor: '#fff' }}>
          ...
          <View style={styles.view_icon}>
            ...
            <View style={styles.v_big}>
              <Text style={styles.txt_big}>Payment Success</Text>
              <View style={styles.view_icon_visa}>
                <Image
                  source={icons.visa_icon}
                  style={styles.icon_visa} />
                <Text style={styles.txt_plete}>Ending with 1321</Text>
              </View>
            </View>
